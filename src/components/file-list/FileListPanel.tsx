...
export const FileListPanel: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-full bg-slate-100 dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 text-slate-800 dark:text-slate-200">
      {/* Action Header */}
            ...
            return (
              ...
              >
                <div className="flex items-center gap-2 overflow-hidden flex-1 mr-2">
                  <span className="text-[10px] text-slate-500 dark:text-slate-500 font-mono w-4">
                    {idx + 1}
                  </span>
